    ...
    render () {
        return (
            <div class="stock-list__grid-row">
                <Modal isVisible={this.state.isModalVisible} closeCallback={this.toggleModal}>
                ...
                <div class="stock-list__grid-cell">
                    ...
                    <span class="stock-list__btn stock-list__btn--remove">&ndash;</span></a>
                </div>
                }
                <div class="stock-list__grid-cell">{this.props.symbol}</div>
                <div class="stock-list__grid-cell">{this.props.price}</div>
                <div class="stock-list__grid-cell">
                    <a onClick={() => this.toggleModal('buy')}><span class="btn-transaction btn-transaction--buy">buy</span></a>
                </div>
                {this.props.amount && 
                <React.Fragment>
                <div class="stock-list__grid-cell">
                    <a onClick={() => this.toggleModal('sell')}><span class="btn-transaction btn-transaction--sell">sell</span></a>
                </div>
